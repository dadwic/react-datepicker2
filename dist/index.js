  ...
  createClass(Day, [{
    ...
    value: function render() {
      ...
      return React__default.createElement("div", {
        ...
        disabled: disabled
      }, rest), isGregorian ? day.format('D') : persianNumber(day.format('jD'))), React__default.createElement("div", {
...
var moment$1 = MomentRange.extendMoment(momentJalaali);
...
var ExecutionEnvironment_2 = ExecutionEnvironment_1.canUseDOM;
...
var vendorPrefixes = getVendorPrefixes(ExecutionEnvironment_2, typeof window !== 'undefined' ? window : {});

var style = {};

if (ExecutionEnvironment_2) {
...
var _defineProperty$2 = unwrapExports(defineProperty$5);
  ...
  var CSSMotion = function (_React$Component) {
    ...
    _createClass$2(CSSMotion, [{
      ...
      value: function render() {
        ...
        return children({
          className: classnames((_classNames = {}, _defineProperty$2(_classNames, getTransitionName$1(motionName, status), status !== STATUS_NONE), _defineProperty$2(_classNames, getTransitionName$1(motionName, status + '-active'), status !== STATUS_NONE && statusActive), _defineProperty$2(_classNames, motionName, typeof motionName === 'string'), _classNames)),
          style: statusStyle
        });
      }
    }], [{
...
function _createClass$3(Constructor, protoProps, staticProps) { if (protoProps) _defineProperties$1(Constructor.prototype, protoProps); if (staticProps) _defineProperties$1(Constructor, staticProps); return Constructor; }

function _possibleConstructorReturn$3(self, call) { if (call && (_typeof$1(call) === "object" || typeof call === "function")) { return call; } return _assertThisInitialized$1(self); }
...
function (_React$Component) {
  ...
  function ContainerRender() {
    ...
    _this = _possibleConstructorReturn$3(this, (_getPrototypeOf2 = _getPrototypeOf(ContainerRender)).call.apply(_getPrototypeOf2, [this].concat(args)));
...
function _possibleConstructorReturn$4(self, call) { if (call && (_typeof$2(call) === "object" || typeof call === "function")) { return call; } return _assertThisInitialized$2(self); }
...
function (_React$Component) {
  ...
  function Portal() {
    ...
    return _possibleConstructorReturn$4(this, _getPrototypeOf$1(Portal).apply(this, arguments));
  }
  ...
  createClass(Header, [{
    ...
    value: function onInputChange(event) {
      ...
      if (str) {
        ...
        var parsed = moment$2(str, format, true);
